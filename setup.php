...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // 6. Write local config (never overwrite db.php — it is version-controlled)
        $localContent = "<?php\n"
            . "// Auto-generated by setup.php — do NOT commit this file\n"
            . "define('DB_HOST',    " . var_export($host,   true) . ");\n"
            . "define('DB_NAME',    " . var_export($dbname, true) . ");\n"
            . "define('DB_USER',    " . var_export($user,   true) . ");\n"
            . "define('DB_PASS',    " . var_export($pass,   true) . ");\n"
            . "define('DB_CHARSET', 'utf8mb4');\n";
        file_put_contents(__DIR__ . '/config/local.php', $localContent);
        file_put_contents(__DIR__ . '/config/.installed', date('Y-m-d H:i:s'));
        step("บันทึกการตั้งค่าฐานข้อมูลใน config/local.php สำเร็จ");
